...
plot_all_rounds_2_levels <-
  ...
  labs(x = "Change in citizens' trust in local government between R2 and R7", y = "Change in citizens' trust in traditional leaders between R2 and R7", title = "Relationships between citizens' trust in local government and traditional leaders", caption = "Source: Afrobarometer")

plot_all_rounds_2_levels
```

## Interpretation of the graph 
In most countries, the more citizens trust in local government 
