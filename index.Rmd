...
plot_allrounds_2levels_polity <-
  ...
  ggplot(aes(x = diff_LG_trust, y = diff_TL_trust)) +
  geom_point() +
  geom_text(aes(label = country_name)) +
  geom_smooth(method = "lm") +
  labs(x = "Change in citizens' trust in LG, R2 and R7", y = "Change in citizens' trust in TL, R2 and R7", title = "Relationships between citizens' trust in LG and TL", caption = "Source: Afrobarometer")
